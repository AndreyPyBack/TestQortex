...
SECRET_KEY = 'django-insecure-=5$a=6m$-(!98z+h2o@cv^e*)_ysuxc@bbx!ph_qpu=jb)%fn*'
...
if os.getenv('POSTGRES_HOST'):
    # Use PostgreSQL from environment variables (Docker/default)
    DATABASES = {
        'default': {
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'API для хранения исполнителей, альбомов и песен',
    'VERSION': '1.0.0',
}
